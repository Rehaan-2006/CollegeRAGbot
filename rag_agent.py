"""College agent that leverages RAG with a local ChromaDB for Pydantic documentation."""
...
agent = Agent(
    "ollama:llama3.2",  # Change to your installed Ollama model
    deps_type=RAGDeps,
    system_prompt=(
...
async def run_rag_agent(
    ...
    """Run the RAG agent to answer a question about College.
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Run a College agent with RAG using ChromaDB")
